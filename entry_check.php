      ...
      <main class="col-lg-9 col-xl-10">
        ...
        <nav class="my_breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">会員登録情報の確認</li>
          </ol>
        </nav>
        <h1 class="setting_h1">会員登録情報の確認</h1>
        <form action="entry_finish.php">
          ...
          <dl class="row reg_info mb-4">
            ...
            <dt class="col-sm-5 col-md-4 col-xl-3">住所</dt>
            <dd class="col-sm-7 col-md-8 col-xl-9">東京都 新宿区 新宿3-12-11 石井ビル3F</dd>
          ...
          <nav class="mb-4 text-center row mb-5 mx-auto pb-4 info_change">
            <button href="javascript:history.back();" class="btn btn_navy col-10 col-sm-5 mb-2 mx-auto">修正する</button>
            ...
            <button type="submit" class="btn btn_green col-10 col-sm-5 mb-2 mx-auto">上記の内容で登録する</button>
          </nav>
        </form>
