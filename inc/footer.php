  ...
  <div class="footer_top container-fluid">
    <div class="row">
      <div class="col-lg-9 col-xl-10 offset-lg-3 offset-xl-2 footer_top_content pb-4 pb-md-5">
        <h4 class="text-center mb-4"><a href="">お薬通販部とは</a></h4>
       ...
       <div class="row justify-content-center">
          ...
          <div class="col-12">
            <p class="tel text-center">
              お電話での注文も受け付けています。
              <img src="common/images/phone-order.jpg" class="img-fluid d-block mx-auto" alt="電話注文：050-5806-4632">
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <nav class="footer_nav">
        <dl class="row small">
          ...
          <dd class="col-6 col-md-4 col-xl-3"><a href="receive-emails.php">メールが届かないお客様へ</a></dd>
          <dd class="col-6 col-md-4 col-xl-3"><a href="faq.php">よくある質問</a></dd>
          <dd class="col-6 col-md-4 col-xl-3"><a href="generic.php">ジェネリック医薬品について</a></dd>
        </dl>
