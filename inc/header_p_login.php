...
<nav class="navbar navbar-expand-lg navbar-dark navbar_main">
    ...
    <ul class="navbar-nav">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu globalnav_dropdown_menu mb-2" aria-labelledby="dropdown01">
          ...
          <div class="btn-group w-100" role="group">
            ...
            <button type="button" class="submenu_toggle" data-toggle="collapse" data-target="#submenu11" aria-expanded="false" aria-controls="submenu11">
              <i class="fa fa-caret-down"></i>
            </button>
          </div>
          <div id="submenu11" class="submenu collapse">
          ...
          <div class="btn-group w-100" role="group">
            ...
            <button type="button" class="submenu_toggle" data-toggle="collapse" data-target="#submenu12" aria-expanded="false" aria-controls="submenu12">
              <i class="fa fa-caret-down"></i>
            </button>
          </div>
          <div id="submenu12" class="submenu collapse">
          ...
          <div class="btn-group w-100" role="group">
            ...
            <button type="button" class="submenu_toggle" data-toggle="collapse" data-target="#submenu13" aria-expanded="false" aria-controls="submenu13">
              <i class="fa fa-caret-down"></i>
            </button>
          </div>
          <div id="submenu13" class="submenu collapse">
          ...
          <div class="btn-group w-100" role="group">
            ...
            <button type="button" class="submenu_toggle" data-toggle="collapse" data-target="#submenu14" aria-expanded="false" aria-controls="submenu14">
              <i class="fa fa-caret-down"></i>
            </button>
          </div>
          <div id="submenu14" class="submenu collapse">
          ...
          <div class="btn-group w-100" role="group">
            ...
            <button type="button" class="submenu_toggle" data-toggle="collapse" data-target="#submenu15" aria-expanded="false" aria-controls="submenu15">
              <i class="fa fa-caret-down"></i>
            </button>
          </div>
          <div id="submenu15" class="submenu collapse">
          ...
          <div id="submenu16" class="submenu collapse">
          ...
          <div id="submenu17" class="submenu collapse">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu globalnav_dropdown_menu mb-2" aria-labelledby="dropdown03">
          ...
          <a href="faq.ph" class="dropdown-item">よくある質問</a>
  ...
  <ul class="navbar-nav icon_nav">
    ...
    <li class="navbar-item dropdown">
      <a class="nav-link dropdown-toggle drop-hover" href="" href="" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
