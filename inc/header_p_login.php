  ...
  <ul class="navbar-nav icon_nav">
    ...
    <li class="navbar-item dropdown">
      ...
      <div class="dropdown-menu globalnav_dropdown_menu mb-2" aria-labelledby="dropdown04">
        <a href="order-history.html" class="dropdown-item"><i class="fas fa-history mr-2"></i>注文履歴</a>
        <a href="personal-page.html" class="dropdown-item"><i class="fab fa-elementor mr-2"></i>メニュー</a>
        <a href="registration-information.html" class="dropdown-item"><i class="fas fa-user-cog mr-2"></i>登録情報</a>
