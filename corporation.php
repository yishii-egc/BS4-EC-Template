...
<title>特定商取引法に基づく表記｜医薬品・サプリメント【お薬通販部】</title>
</head>
<body>
  ...
  <div class="container-fluid">
    <div class="row justify-content-lg-center">
      <main class="col-lg-9 col-xl-10">
        ...
        <h1 class="corporation_h1">特定商取引法に基づく表記</h1>

        <picture>
          <source srcset="images/info/corporation_sp.png" media="(max-width:767.98px)">
          <source srcset="images/info/corporation_pc.png" media="(min-width:768px)">
          <img class="img-fluid mt-2 mb-5" src="images/info/corporation_pc.png" alt="">
        </picture>
