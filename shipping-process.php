...
<title>お買い物手順｜ご注文方法の流れ【お薬通販部】</title>
</head>
<body>
            ...
            <div class="col-md-4 order-md-last guide_toc">
              <nav class="card small mb-4">
                <div class="list-group-flush">
                  ...
                  <a href="#guide01" class="list-group-item">ネットで注文</a>
                  <a href="#guide01_01" class="list-group-item pl-5">注文したい商品をカートに入れる</a>
                  <a href="#guide01_02" class="list-group-item pl-5">ショッピングカートページを確認する</a>
            ...
            <div class="col-md-8 guide_main">
              ...
              <ul>
                <li class="mb-4">
                  注文したい商品の紹介ページへ移動します。
                  <picture>
                    <source srcset="images/guide/guide_add_cart01sp.png" media="(max-width:767.98px)">
                    <source srcset="images/guide/guide_add_cart01pc.png" media="(min-width:768px)">
                    <img class="img-fluid img-thumbnail my-2" src="images/guide/guide_add_cart01pc.png" alt="">
                  </picture>
                </li>
                <li class="mb-4">
                  商品ページのカートに入れるボタンをクリックします（用量等お間違えの無いようご注意ください）。
                  <picture>
                    <source srcset="images/guide/guide_add_cart02sp.png" media="(max-width:767.98px)">
                    <source srcset="images/guide/guide_add_cart02pc.png" media="(min-width:768px)">
                    <img class="img-fluid img-thumbnail my-2" src="images/guide/guide_add_cart02pc.png" alt="">
                  </picture>
                </li>
                <li class="mb-4">
                  ショッピングカートへ商品が入ったことをご確認ください。
                  <picture>
                    <source srcset="images/guide/guide_add_cart03sp.png" media="(max-width:767.98px)">
                    <source srcset="images/guide/guide_add_cart03pc.png" media="(min-width:768px)">
                    <img class="img-fluid img-thumbnail my-2" src="images/guide/guide_add_cart03pc.png" alt="">
                  </picture>
                </li>
              </ul>
              ...
              <dl>
                <dt>数量を変更しない場合</dt>
                <dd>『合計』欄の金額を確認してください。</dd>
                <dt>数量を変更する場合</dt>
                <dd>
                  <span class="d-block">ボタンを押します。「合計」欄の金額が修正されたことをご確認ください。</span>
                <img src="images/guide/guide_cart_change.png" alt="" class="img-fluid img-thumbnail">
                </dd>
              </dl>
              ...
              <dl>
                <dt>初回注文のお客様へ</dt>
                <dd>
                  初回注文のお届け先登録情報を「お薬通販部の会員登録」とさせていただいております。<br>
                  次回以降は、お届け先登録情報で入力したメールアドレスとパスワードで「ログイン」することができます。登録情報・注文履歴等の会員メニューの活用、その他会員向けサービスをご利用いただけます。
                </dd>
                <dt>既に会員登録がお済みのお客様へ</dt>
                <dd>
                  会員ページにログインすると、配送先情報の登録欄に会員登録情報が表示されます。
                  <ol>
                    <li>ページ右上にある「ログイン」ボタンを押し、ご登録のメールアドレスおよびパスワードを入力して会員ページへログインください。</li>
                    <li>「お届け先登録情報とお支払い方法」ページへと移動するとご登録の会員情報が表示されます。</li>
                    <li>内容の確認・追加入力の上、購入手続きを進めてください。</li>
                  </ol>
                </dd>
              </dl>
              ...
              <p>
                ...
                内容に間違いがなければ「注文を確定する」ボタンを押してください。
              </p>
              <p><img src="images/guide/guide_register.png" alt="" class="img-fluid img-thumbnail"></p>
              <p class="textRed text-center">
                <span class="d-block"><i class="fa fa-caret-down fa-2x"></i></span>
                ご注文完了です
              </p>
              <p>ご登録のメールアドレスに、注文完了メールを送信いたします。<br>
