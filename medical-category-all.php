...
<meta name="description" content="薬ストアで取り扱う商品のカテゴリー一覧ページです。お得なセット商品、ED治療薬、男性薄毛治療薬、避妊薬など、さまざまな医薬品・サプリメントを目的別に探しやすいリストにしています。【薬ストア】商品カテゴリー一覧">
...
<title>商品カテゴリー一覧｜医薬品・サプリメント【薬ストア】</title>
</head>
<body>
      ...
      <main class="col-lg-9 col-xl-10">
        ...
        <nav class="my_breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb my_breadcrumb">
            <li class="breadcrumb-item"><a href="index.php">薬ストアTOP</a></li>
            <li class="breadcrumb-item active" aria-current="page">メディカル知識一覧</li>
          </ol>
        </nav>

        <header>
          <h1 class="categroy_h1">メディカル知識一覧</h1>
          <p class="category_description">
            薬ストアで取り扱う商品のカテゴリー一覧ページです。<br>
          ...
          <ul class="row list-unstyled">
            ...
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              ...
              <div class="category_child list-group mt-2 collapse" id="child01">
                ...
                <a href="category.php" class="list-group-item">ステンドラジェネリック</a>
                <a href="category.php" class="list-group-item">ザイデナジェネリック</a>
            ...
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              ...
              <div class="category_child list-group mt-2 collapse" id="child05">
                ...
                <a href="category.php" class="list-group-item">避妊具</a>
              </div>
            </li>
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              <a href="category.php" class="category_item">
              ...
              <div class="category_child list-group mt-2 collapse" id="child06">
                ...
                <a href="category.php" class="list-group-item">ヘアケアシャンプー</a>
                <a href="category.php" class="list-group-item">男性薄毛サプリ</a>
              </div>
            </li>
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              <a href="category.php" class="category_item">
            ...
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              ...
              <div class="category_child list-group mt-2 collapse" id="child08">
                ...
                <a href="category.php" class="list-group-item">石鹸</a>
            ...
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              ...
              <div class="category_child collapse" id="child13">
                ...
                <a href="category.php" class="list-group-item">アルコール依存症</a>
                <a href="category.php" class="list-group-item">てんかん・ADHD</a>
                <a href="category.php" class="list-group-item">スマートドラッグ</a>
            ...
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              ...
              <div class="category_child collapse" id="child14">
                ...
                <a href="category.php" class="list-group-item">高脂血症</a>
            ...
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              ...
              <div class="category_child list-group mt-2 collapse" id="child15">
                ...
                <a href="category.php" class="list-group-item">関節・リウマチ</a>
              </div>
            </li>
            <li class="col-6 col-md-4 col-xl-3 mb-4">
              <a href="category.php" class="category_item">
