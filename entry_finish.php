...
<title>登録完了｜医薬品・サプリメント【お薬通販部】</title>
</head>
<body>
      ...
      <main class="col-lg-9 col-xl-10">
        ...
        <nav class="my_breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">登録が完了しました</li>
          </ol>
        </nav>
        <h1 class="setting_h1">登録が完了しました</h1>
        <p>ご登録ありがとうございました。</p>
        <p><a href="index.php" class="btn btn_green">TOPページに戻る</a></p>
