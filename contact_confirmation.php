      ...
      <main class="col-lg-9 col-xl-10">
        ...
        <nav class="my_breadcrumb" aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">お問い合わせ内容の確認</li>
          </ol>
        </nav>
        <h1 class="contact_h1">お問い合わせ内容の確認</h1>
        <p>
          以下のご入力内容で問題なければ「この内容で送信」を押してください。<br>
          内容を修正する場合は「入力に戻る」を押してください。
        </p>
